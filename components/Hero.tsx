...
=======
          ...
          {/* Location & Date - Enhanced with Icons */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative p-6 md:p-8 bg-white bg-opacity-5 backdrop-blur-xl rounded-2xl border border-white border-opacity-10 hover:border-opacity-40 transition-all duration-300 hover:bg-opacity-10 hover:shadow-2xl hover:shadow-primary/40 transform hover:-translate-y-2"
